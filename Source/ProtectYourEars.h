...
// Notes:
// - This function is intended as a debug/safety helper;
//   DBG is relatively CPU expensive and should be disabled in release builds.
// - Clearing the whole buffer is a blunt but safe action to prevent loud output;
//   Note: consider more targeted handling in production.
// - Running these checks sample-by-sample on the audio thread can be CPU-heavy;
//   Just keeping for development builds only.
// ***************************************************************************
