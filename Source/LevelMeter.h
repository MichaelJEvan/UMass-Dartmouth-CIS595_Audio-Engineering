/*
  ==============================================================================
    ...
    Simple UI component that displays L/R level meters driven by Measurement objects.
  ==============================================================================
*/
...
private:
    ...
    // Convert dB level to a pixel position; used to map dB -> vertical meter coordinate
