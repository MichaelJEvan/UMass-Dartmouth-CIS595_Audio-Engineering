/* ***********************************************************
     ...
     LedLight.h
     Created: 23 Feb 2026 (❄️❄️❄️ The Blizzard Addition ❄️❄️❄️)
     Michael J Evan
     CIS-595 Independent Study
     UMass Dartmouth Graduate Computer Science Dept.
     Spring 2026
 
            ***** Bonus Sync LED light *****
 
 Led Sync light code finalized: Feb 23, 2026
...
public:
    ...
    void paint(juce::Graphics& g) override
    {
        ...
        // glow amount is the leftover space ... keep inside bounds
        ...
        // main circle (center)
        g.setColour(state ? colour : juce::Colours::darkgrey);  // inactive LED color darkgrey
        g.fillEllipse(inner);
...
private:
    ...
    float centerScale { 0.70f }; // default: center is 70% of component diameter
